...
export class FoodsDialogComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: Foods,
  ...
  public update(): void {
    ...
    this.snackBar.open('Uspešno izmenjena hrana ' + this.data.foodName, 'U redu', {duration: 2000});
  }
  ...
  compareTo(a: Employees, b: Employees): boolean {
    if (a == null || b == null) {
      return false;
    }
